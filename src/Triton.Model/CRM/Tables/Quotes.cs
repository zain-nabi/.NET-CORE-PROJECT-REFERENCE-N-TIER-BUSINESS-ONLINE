...
namespace Triton.Model.CRM.Tables
{
    ...
    public class Quotes
    {
        ...
        [Display(Name = "Senders Latitude")]
        public string SenLatitude { get; set; }
        [Display(Name = "Senders Longitude")]
        public string SenLongitude { get; set; }
        [Display(Name = "Senders Google Plus Code")]
        public string SenPlusCode { get; set; }
        [Display(Name = "Receivers Latitude")]
        public string RecLatitude { get; set; }
        [Display(Name = "Receivers Longitude")]
        public string RecLongitude { get; set; }
        [Display(Name = "Receivers Google Plus Code")]
        public string RecPlusCode { get; set; }
    }
}
